...
import { uploadFile, getFiles, downloadFile, deleteFile, getFilesByUploadedBy, getFilesByProjectNames } from "../Controller/FileUploadController.js";
...
router.post("/by-projects", verifyToken, getFilesByProjectNames);
